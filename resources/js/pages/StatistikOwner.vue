      ...
      <main class="flex-1 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div class="bg-green-100 dark:bg-green-900/40 border border-green-300 dark:border-green-700/50 rounded-3xl p-6 shadow-2xl shadow-slate-950/40">
            <div class="flex items-center justify-between">
              <div>
                <p class="text-slate-600 dark:text-slate-400 text-sm">Alat Tersedia</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="space-y-4">
              <div>
                <div class="flex justify-between mb-2">
                  <span class="text-slate-700 dark:text-slate-300">Tersedia</span>
              ...
              <div>
                <div class="flex justify-between mb-2">
                  <span class="text-slate-700 dark:text-slate-300">Dipinjam</span>
          ...
          <div class="app-card app-card--cyan p-6">
            ...
            <div class="space-y-4">
              ...
              <div>
                <div class="flex justify-between mb-2">
                  <span class="text-slate-700 dark:text-slate-300">Pending</span>
            ...
            <table class="w-full">
              <thead>
                <tr class="text-left text-slate-600 dark:text-slate-400 text-sm border-b border-slate-200 dark:border-slate-800">
                  ...
                  <th class="pb-3 font-semibold">Total Peminjaman</th>
