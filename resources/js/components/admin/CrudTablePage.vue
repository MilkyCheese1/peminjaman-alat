<template>
  <div class="min-h-screen bg-slate-50 dark:bg-slate-950 flex">
    ...
    >
      <section class="w-full max-w-2xl max-h-[90vh] overflow-hidden rounded-[2rem] border border-cyan-200 bg-white shadow-2xl shadow-slate-950/40 dark:border-cyan-500/20 dark:bg-slate-900 flex flex-col">
